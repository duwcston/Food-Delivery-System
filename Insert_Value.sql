...
Values (1,1,1,1,1,1,1,2023-02-14, 4);

Insert Bill_reports ( Bill_ID,Cust_Id, Order_Id, Supply_Id ,Food_Id, Delivery_Id, Payment_Id, Date, Rating )
Values (2,2,2,2,2,2,2,2023-02-21, 4);

Insert Bill_reports ( Bill_ID,Cust_Id, Order_Id, Supply_Id ,Food_Id, Delivery_Id, Payment_Id, Date, Rating  )
Values (3,3,3,3,3,3,3,2023-02-24, 4);

Insert Bill_reports ( Bill_ID,Cust_Id, Order_Id, Supply_Id ,Food_Id, Delivery_Id, Payment_Id, Date, Rating  )
Values (4,4,4,4,4,4,4,2023-02-14, 4);

Insert Bill_reports ( Bill_ID,Cust_Id, Order_Id, Supply_Id ,Food_Id, Delivery_Id, Payment_Id, Date, Rating  )
Values (5,5,5,5,5,5,5,2023-01-31, 4);

Insert  Bill_reports ( Bill_ID,Cust_Id, Order_Id, Supply_Id ,Food_Id, Delivery_Id, Payment_Id, Date, Rating  )
Values (6,6,6,6,6,6,6,2023-02-02, 4);

Insert  Bill_reports ( Bill_ID,Cust_Id, Order_Id, Supply_Id ,Food_Id, Delivery_Id, Payment_Id, Date, Rating  )
Values (7,7,7,7,7,7,7,2023-01-25, 4);

Insert  Bill_reports ( Bill_ID,Cust_Id, Order_Id, Supply_Id ,Food_Id, Delivery_Id, Payment_Id, Date, Rating )
Values (8,8,8,8,8,8,8,2023-01-10, 4);

Insert Bill_reports ( Bill_ID,Cust_Id, Order_Id, Supply_Id ,Food_Id, Delivery_Id, Payment_Id, Date, Rating )
Values (9,9,9,9,9,9,9,2023-01-06, 4);

Insert  Bill_reports ( Bill_ID,Cust_Id, Order_Id, Supply_Id ,Food_Id, Delivery_Id, Payment_Id, Date, Rating )
Values (10,10,10,10,10,10,10,2023-02-28, 4);
